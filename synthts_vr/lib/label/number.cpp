...
CFSWString onesName[] = {
        L"üts'", L"kats'", L"kolm", L"neli", L"viis'", L"kuus'", L"säidse", L"katõsa", L"ütesä"
    };

    CFSWString teensName[] = {
        L"kümme", L"üts'tõist", L"kats'tõist", L"kolmtõist", L"nelitõist", L"viis'tõist", L"kuus'tõist", L"säidsetõist", L"katõsatõist", L"ütesätõist"
    };

    CFSWString tensName[] = {
        L"kats'kümmend", L"kolmkümmend", L"nelikümmend", L"viis'kümmend", L"kuus'kümmend", L"säidsekümmend", L"katõsakümmend", L"ütesäkümmend"
    };

    CFSWString onesNameO[] = {
        L"edimäne", L"tõõnõ", L"kolmas", L"neläs", L"viies", L"kuvvõs", L"säitsmes", L"katsas", L"ütsäs",
    };

    CFSWString teensNameO[] = {
        L"kümnes", L"ütestõistkümnes", L"katõstõistkümnes", L"kolmõstõistkümnes", L"nelästõistkümnes",
        L"viiestõistkümnes", L"kuvvõstõistkümnes", L"säitsmestõistkümnes", L"katsastõistkümnes", L"ütsästõistkümnes"
    };

    CFSWString tensNameO[] = {
        L"katõkümne", L"kolmõkümne", L"neläkümne", L"viiekümne", L"kuvvõkümne", L"säitsmekümne", L"katsakümne", L"ütsäkümne"
    };    
